...
public class SuccessfulLoginPage {
     ...
     * @return
     */
    public SuccessfulLoginPage clickSubmenuOfReportMenuNamed(String submenuItem) {
        $x(xpathForReportIconMenuItem).hover();
        $x(xpathForReportIconMenuItem).$x(String.format("./ancestor::li//span[contains(text(),'%s')]", submenuItem))
                .hover().click();
        return this;
    }
